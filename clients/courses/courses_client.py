...
from clients.courses.courses_schema import CoursesQueryParamsSchema, CreateCourseRequestSchema, UpdateCourseRequestSchema, CreateCourseResponseSchema

class CoursesClient(APIClient):
    """
    Клиент для работы с /api/v1/courses
    """
    def get_courses_api(self, query: CoursesQueryParamsSchema) -> Response:
        """
    ...
    def create_course(self, request: CreateCourseRequestSchema) -> CreateCourseResponseSchema:
        ...
        :param request: Модель с данными курса.
